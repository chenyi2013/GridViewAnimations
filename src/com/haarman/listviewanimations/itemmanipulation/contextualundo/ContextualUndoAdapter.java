...
public class ContextualUndoAdapter extends BaseAdapterDecorator implements ContextualUndoListViewTouchListener.Callback {
	...
	public void setGridView(GridView gridView) {
		...
		ContextualUndoListViewTouchListener contextualUndoListViewTouchListener = new ContextualUndoListViewTouchListener(gridView, this);
		gridView.setOnTouchListener(contextualUndoListViewTouchListener);
		gridView.setOnScrollListener(contextualUndoListViewTouchListener.makeScrollListener());
		gridView.setRecyclerListener(new RecycleViewListener());
	}
